...
//****EM IRFs
stoch_simul(order=1,nomoments,noprint,EMAS_GIRF,stderr_multiples,diagonal_only) y c k a b;
...
stoch_simul(order=1,nomoments,noprint,analytical_GIRF,stderr_multiples,diagonal_only) y c k a b;
