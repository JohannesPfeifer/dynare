function P=lyapunov_solver_two_inputs(T,RQR,DynareOptions) % --*-- Unitary tests --*--
% function P=lyapunov_solver_two_inputs(T,RQR,DynareOptions)
% Solves the Lyapunov equation P-T*P*T' = RQR arising in a state-space
...
if DynareOptions.lyapunov_fp == 1
    P = lyapunov_symm(T,RQR,DynareOptions.lyapunov_fixed_point_tol,DynareOptions.qz_criterium,DynareOptions.lyapunov_complex_threshold, 3, DynareOptions.debug);
elseif DynareOptions.lyapunov_db == 1
    [P, errorflag] = disclyap_fast(T,RQR,DynareOptions.lyapunov_doubling_tol);
    if errorflag %use Schur-based method
        P = lyapunov_symm(T,RQR,DynareOptions.lyapunov_fixed_point_tol,DynareOptions.qz_criterium,DynareOptions.lyapunov_complex_threshold, [], DynareOptions.debug);
    end
...
%$ try
%$    Pstar1_small = lyapunov_solver(T_small,R_small*Q_small*R_small',options_);
%$    Pstar1_large = lyapunov_solver(T_large,R_large*Q_large*R_large',options_);
%$    t(1) = 1;
%$ catch
%$    t(1) = 0;
%$ end
...
%$ try
%$    Pstar2_small = lyapunov_solver(T_small,R_small*Q_small*R_small',options_);
%$    Pstar2_large = lyapunov_solver(T_large,R_large*Q_large*R_large',options_);
%$    t(2) = 1;
%$ catch
%$    t(2) = 0;
%$ end
...
%$     try
%$        Pstar3_small = lyapunov_solver(T_small,R_small*Q_small*R_small',options_);
%$        Pstar3_large = lyapunov_solver(T_large,R_large*Q_large*R_large',options_);
%$        t(3) = 1;
%$     catch
%$        t(3) = 0;
%$     end
...
%$ try
%$    Pstar4_small = lyapunov_solver(T_small,R_small*Q_small*R_small',options_);
%$    Pstar4_large = lyapunov_solver(T_large,R_large*Q_large*R_large',options_);
%$    t(4) = 1;
%$ catch
%$    t(4) = 0;
%$ end
